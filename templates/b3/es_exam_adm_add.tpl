...
<{/if}>
  ...
  <div class="row">
    ...
    <div class="col-md-8  col-xs-8"><input type="text" name="title" value="<{$title}>" class="form-control"  placeholder="<{$smarty.const._MA_TADASSIGN_TITLE}>"></div>

  </div>

  <div class="row">
    <div class="col-md-2  col-xs-2"><{$smarty.const._MA_TADASSIGN_PASSWD}></div>
    <div class="col-md-3  col-xs-3"><input type="text" name="passwd" class="form-control" value="<{$passwd}>" placeholder="<{$smarty.const._MA_TADASSIGN_PASSWD}>"></div>
  ...
  <div class="row">
    ...
    <div class="col-md-3  col-xs-3"><input type="text" name="ext_file" class="form-control" value="<{$ext_file}>" placeholder="例： jpg,jpeg,png "></div>
    <div class="col-md-5  col-xs-5">(逗號分隔多種副檔名，依此類別做線上展示（PDF,scratch...)，空白表示不限制。)</div>
  ...
  <div class="row">
    ...
    <div class="col-md-8 col-xs-8"><textarea name="note"  class="form-control" rows=4 placeholder="<{$smarty.const._MA_TADASSIGN_NOTE}>"><{$note}></textarea></div>
  </div>

  <div class="row">
    <div class="col-md-2 col-xs-2">允許上傳或撰寫文字</div>
